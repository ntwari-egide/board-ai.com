 ...
 */
export default function ConversationView({ onSendMessage }: ConversationViewProps) {
  ...
  useEffect(() => {
    (window as any).addConversationMessage = (content: string, files: File[]) => {
  ...
  return (
    <div className='flex-1 overflow-y-auto bg-gray-50'>
      <div className='mx-auto max-w-3xl px-6 pb-4 pt-6'>
