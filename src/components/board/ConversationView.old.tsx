...
const initialMessages: Message[] = [
  {
    ...
    personaId: 'user',
    content:
      'I want to build a high-end mobile app for architecture enthusiasts to share and critique building designs using augmented reality.',
    timestamp: new Date(),
  },
  {
    id: 'msg-2',
...
export default function ConversationView({
  ...
  useEffect(() => {
    (window as any).addConversationMessage = (
      ...
      const respondingPersonas = getRandomPersonas(
        ...
        {messages.map((message) => {
          ...
          const persona =
            message.personaId === 'user'
              ...
              : dummyPersonas.find((p) => p.id === message.personaId) ||
                dummyPersonas[0];
